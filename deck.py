...
class Player:
    ...
    def peel(self):
        ...
        '''
        if len(self.public_deck.pile) < 1:
            return None
        else:
            ret = self.public_deck.pile[-1]
            del self.public_deck.pile[-1]
    ...
    def add_tile_sprites(self):
        ...
        for i, letter in enumerate(self.deck):
            ...
            #rect = pygame.Rect(i * h.TILE_SIZE, (h.HEIGHT - 3 * h.TILE_SIZE) -  h.TILE_SIZE, h.TILE_SIZE,  h.TILE_SIZE)
